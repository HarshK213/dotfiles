...
kmap("n", "<C-t>", ":NeotreeFocus<CR>", opts)
...
kmap("n", "<F6>", ":vsp<CR>:terminal<CR>", opts)
kmap("n", "<S-Tab>", ":bprevious", opts)
kmap("n", "<Tab>", ":bnext", opts)
kmap("n", "<space>f", ':lua require("telescope.builtin").find_files()<CR>', opts)
kmap("n", "<Leader>b", ':lua require("telescope.builtin").buffers()<CR>', opts)
